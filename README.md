...
<head>
    ...
    <title>Embedded Tableau Chart</title>
</head>
<body>
    <h1>Volatility of Interbank Rates - June 2024</h1>
    <div class='tableauPlaceholder' id='viz1721415416604' style='position: relative'>
        <noscript>
            <a href='#'>
                <img alt='Volatility of Interbank RatesJune 2024 ' src='https://public.tableau.com/static/images/Vo/VolatilityofInterbankRatesJune2024/VolatilityofInterbankRatesJune2024/1_rss.png' style='border: none' />
            </a>
        </noscript>
        <object class='tableauViz' style='display:none;'>
            ...
            <param name='name' value='VolatilityofInterbankRatesJune2024/VolatilityofInterbankRatesJune2024' />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https://public.tableau.com/static/images/Vo/VolatilityofInterbankRatesJune2024/VolatilityofInterbankRatesJune2024/1.png' />
    ...
    <script type='text/javascript'>
        var divElement = document.getElementById('viz1721415416604');
